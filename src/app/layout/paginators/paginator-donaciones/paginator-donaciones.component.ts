...
@Component({
  selector: 'app-paginator-donaciones-nav',
  templateUrl: './paginator-donaciones.component.html'
})
export class PaginatorDonacionesComponent implements OnInit, OnChanges {
